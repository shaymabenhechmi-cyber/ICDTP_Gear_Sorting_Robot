  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x06, 0x2e, 0x47, 0x87, 0x8d, 0x92, 0x54, 0xf6,
      0xdb, 0x37, 0xfb, 0x45, 0x33, 0xd9, 0xaf, 0x4e,
      0x3d, 0x07, 0x22, 0x5d, 0x2d, 0x48, 0xe0, 0x88,
      0x79, 0x44, 0xfc, 0xd5, 0xf2, 0x84, 0xcd, 0x56,
    }};
  return &hash;
}
...
static char my_robot_interfaces__msg__RobotCommand__FIELD_NAME__base_id[] = "base_id";
static char my_robot_interfaces__msg__RobotCommand__FIELD_NAME__target_pose[] = "target_pose";
static char my_robot_interfaces__msg__RobotCommand__FIELD_NAME__gripper_state[] = "gripper_state";

static rosidl_runtime_c__type_description__Field my_robot_interfaces__msg__RobotCommand__FIELDS[] = {
  {
    {my_robot_interfaces__msg__RobotCommand__FIELD_NAME__base_id, 7, 7},
    {
  ...
  {
    {my_robot_interfaces__msg__RobotCommand__FIELD_NAME__target_pose, 11, 11},
    {
  ...
  {
    {my_robot_interfaces__msg__RobotCommand__FIELD_NAME__gripper_state, 13, 13},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription my_robot_interfaces__msg__RobotCommand__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    ...
    {my_robot_interfaces__msg__RobotCommand__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
